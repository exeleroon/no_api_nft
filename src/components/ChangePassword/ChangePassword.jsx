...
import { changePassword, getUserToken, updateMyProfile } from 'redux/auth-reducer'
...
const ChangePassword = () => {
    ...
    const onFinish = async values => {
        form.resetFields();
        dispatch(changePassword({oldPassword: values.old_password, newPassword: values.password}))
    }
        ...
        <>
            <DefaultSection>
                <DefaultContainer maxWidth={'600'}>
                    ...
                    <Form name='restore_password' form={form} onFinish={onFinish} onFinishFailed={onFinishFailed}>
                        <FormRow>
                            <Form.Item
                                name='old_password'
                                hasFeedback
                            ...
                            >
                                <StyledPasswordInput placeholder='Текущий пароль' size='large' />
                            </Form.Item>
                        </FormRow>
                        <FormRow>
                            <Form.Item
